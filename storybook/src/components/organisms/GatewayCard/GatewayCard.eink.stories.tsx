...
const meta = {
  title: "Components/Organisms/GatewayCard/E-ink",
 ...
 * Pillow converter to produce the panel-output PNG (`bun run eink`).
 */
 ...
 * (`scripts/eink_convert.py`, the real threshold quantization). Shown 1:1 — this is exactly
 * what the Waveshare 4-colour e-paper displays. Regenerate with `bun run eink` after any
 * visual change to the GatewayCard.
 */
